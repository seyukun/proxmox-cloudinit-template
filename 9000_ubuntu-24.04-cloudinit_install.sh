...
IMAGE_URL=https://ftp.udx.icscoe.jp/Linux/ubuntu-cloud-images/noble/current/noble-server-cloudimg-amd64.img
...
BRIDGE=vmbr0
STORAGE=local-lvm
CICUSTOM_USER=local:snippets/${VM_ID}_ubuntu-24.04-cloudinit_user.yaml
CICUSTOM_META=local:snippets/${VM_ID}_ubuntu-24.04-cloudinit_meta.yaml
